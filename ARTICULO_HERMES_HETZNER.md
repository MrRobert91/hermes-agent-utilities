...
12. [Cron diario de resumen por proyecto](#12-cron-diario-de-resumen-por-proyecto)
...
15. [Pasar un prototipo a producción con Sliplane](#15-pasar-un-prototipo-a-producción-con-sliplane)
...
| **Reverse proxy con HTTPS automático** (Caddy) | Opcional, fuera del alcance de este artículo | No tienes subdominios HTTPS para los prototipos |
| **Cada prototipo generado por Hermes** | Consecuencia natural del enfoque basado en contenedores | Cada proyecto contaminaría dependencias del sistema; sin aislamiento entre prototipos |
